...
<body>
    {{-- NAVBAR START --}}
    <nav class=" bg-transparent font-poppins relative z-20">
    ...
    {{-- HERO START --}}
    <section class="h-screen bg-gray-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')]">
        <div
